...
f2=sys.argv[1]+"/"+sys.argv[2]+"MB/csv/"+sys.argv[2]+"-MB_numa_explicit_gbs_copy_device_cuda.csv"
...
f6=sys.argv[1]+"/"+sys.argv[2]+"MB/csv/"+sys.argv[2]+"-MB_numa_memcpyasync_gbs_copy_device_cuda.csv"
...
plt.title("Throughput (GB/s) of cudaMemcpy on "+sys.argv[1])
...
plt.title("Throughput (GB/s) of copies from device (cudaMalloc allocation) on "+sys.argv[1])
plt.suptitle(sys.argv[2]+"MB - Host To Device")
plt.xlabel('GPU Number')
plt.ylabel('Core Number')
fsave=res_dir+sys.argv[2]+"-MB_"+sys.argv[1]+"_HtD_copy_device_cuda.pdf"
plt.savefig(fsave, format="pdf", bbox_inches="tight")
...
plt.xlabel('GPU Number')
plt.ylabel('Core Number')
fsave=res_dir+sys.argv[2]+"-MB_"+sys.argv[1]+"_DtH_copy_device_cuda.pdf"
plt.savefig(fsave, format="pdf", bbox_inches="tight")
...
plt.title("Throughput (GB/s) of cudaMemcpyAsync on "+sys.argv[1])
plt.suptitle(sys.argv[2]+"MB - Host To Device")
plt.xlabel('GPU Number')
plt.ylabel('Core Number')
...
plt.xlabel('GPU Number')
plt.ylabel('Core Number')
fsave=res_dir+sys.argv[2]+"-MB_"+sys.argv[1]+"_HtD_async_copy_device_cuda.pdf"
plt.savefig(fsave, format="pdf", bbox_inches="tight")
...
plt.xlabel('GPU Number')
plt.ylabel('Core Number')
fsave=res_dir+sys.argv[2]+"-MB_"+sys.argv[1]+"_async_DtH_copy_device_cuda.pdf"
plt.savefig(fsave, format="pdf", bbox_inches="tight")
